  ...
  return (
    <div className="min-h-screen bg-[#050709] flex items-center justify-center p-6 py-12">
      <div className="w-full max-w-sm">
        ...
        <AuthButton variant="google" loading={googleLoading} onClick={handleGoogleSignup} className="mb-5">
        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <span className="text-[11px] text-gray-700 font-medium">or register with email</span>
          <div className="flex-1 h-px bg-white/[0.06]" />
        </div>
