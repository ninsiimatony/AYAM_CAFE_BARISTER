          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className={`text-xs leading-none mt-0.5 truncate ${isActive ? 'text-blue-200' : 'text-gray-500'}`}>
                  {item.description}
                </p>
              </div>
              {item.badge && (
                <span className="shrink-0 rounded-full bg-green-500 px-1.5 py-0.5 text-[10px] font-bold text-white animate-pulse">
                  {item.badge}
                </span>
              )}
            </Link>
